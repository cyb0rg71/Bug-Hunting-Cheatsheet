...
### Accepting arbitrary signatures [ JWT authentication bypass via unverified signature ]
...
### Accepting tokens with no signature [ JWT authentication bypass via flawed signature verification ]
```
